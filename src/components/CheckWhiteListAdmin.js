    ...
    var submit = (event) => {
        ...
        async function ownerOf() {
            if (typeof window.ethereum !== 'undefined') {
                setStatus("wait");
                if(CheckAdmin.length < 42){
                    setStatus("Address Length less then 42 Character");
                }
                else if (checkAdmin.length > 42){
                    ...
                    try {
                        ...
                        const sendTX = await contract.WhiteListAdmin(CheckAdmin)
                        // await sendTX.wait()
                                ...
                                <div className="card-body p-lg-3 p-4 text-black">
                                    ...
                                    <form  onSubmit={submit}>
                                        ...
                                        <div className="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span className="h4 fw-bold mb-0">Check White Admin</span>
                                        </div>

                                        {/* <h5 className="fw-normal mb-3 pb-3">Sign into your account</h5> */}

                                        <div className="form-outline mb-3">
                                            <input name='checkAdmin' value={checkAdmin} onChange={CheckAdmin}  type="text" id="form2Example17" className="form-control" placeholder='Enter Admin Address' />
...
export default CheckWhiteListAdmin